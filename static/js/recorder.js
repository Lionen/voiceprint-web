...
(function (window) {
    ...
    var Recorder = function (stream, config) {
        ...
        config.sampleRate = config.sampleRate || (48000 / 6);   //采样率(1/6 44100)
        ...
        var audioData = {
            ...
            duration:function(){
                return (4096 * this.buffer.length)  / this.inputSampleRate
            }
        ...
        //停止
        this.stop = function () {
            // return document.querySelector(dom).innerHTML = currentTime;
            recorder.disconnect();
